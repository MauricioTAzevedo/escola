...
@C:/Users/Maurício/Downloads/escola/.opencode/get-shit-done/references/thinking-models-research.md
...
```bash
node "C:/Users/Maurício/Downloads/escola/.opencode/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
