...
```
Agent(
  prompt="Read C:/Users/Maurício/Downloads/escola/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Maurício/Downloads/escola/.opencode/get-shit-done/templates/SECURITY.md`
