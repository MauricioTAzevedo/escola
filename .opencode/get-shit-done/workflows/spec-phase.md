...
```bash
INIT=$(node "C:/Users/Maurício/Downloads/escola/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/Maurício/Downloads/escola/.opencode/get-shit-done/templates/spec.md.
