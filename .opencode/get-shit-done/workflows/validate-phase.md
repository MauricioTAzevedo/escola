...
```
Agent(
  prompt="Read C:/Users/Maurício/Downloads/escola/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Maurício/Downloads/escola/.opencode/get-shit-done/templates/VALIDATION.md`
