...
INSTALL_JS_GLOBAL="C:/Users/Maurício/Downloads/escola/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/Maurício/Downloads/escola/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
