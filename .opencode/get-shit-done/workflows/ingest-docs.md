...
```bash
INIT=$(node "C:/Users/Maurício/Downloads/escola/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/Maurício/Downloads/escola/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
